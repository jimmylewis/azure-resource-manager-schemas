...
suite("utilities", () => {
    ...
    suite("readJSONPath(string, string)", () => {
        ...
        test("with schema folder path and matching uri", () => {
            const result = utilities.readJSONPath("https://raw.githubusercontent.com/fearthecowboy/azure-resource-manager-schemas/relative/schemas/2015-01-01/deploymentTemplate.json#", "../schemas");
            assert(result);
            assert.deepStrictEqual(typeof result, "object");
        });
    });
